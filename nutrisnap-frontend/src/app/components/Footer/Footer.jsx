...
const Footer = () => {
  ...
  return (
    <>
      {darkbg ? null : (
        <div>
          <footer className="bg-gray-100 bg-opacity-10 text-center justify-center dark:bg-transparent text-black lg:text-left mt-20">
            ...
            <div className="mx-6 py-10 text-center md:text-left">
              <div className="grid-1 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
                <div>
                  ...
                  <p>
                    Welcome to NutriSnap, your go-to destination for
                    personalized nutrition and wellness solutions. At NutriSnap,
                    we believe in the transformative power of healthy living and
